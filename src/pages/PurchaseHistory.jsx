...
const PurchaseHistory = () => {
  ...
  const handleBuyAgain = (productId) => {
    // Navigate to the product page for the selected product
    navigate(`/`);
  };
                    ...
                    <div key={product._id} className="new-product">
                      ...
                      <div className="new-product-details-wrapper">
                        ...
                        <div className="new-product-details-right">
                          <button
                            className="new-buy-again"
                            onClick={() => handleBuyAgain(product._id)} // Update this line
                          >
                            Buy again
                          </button>
                          <button className="new-view-product"
                          onClick={()=>handleViewProduct()}>View product</button>
                        </div>
                      </div>
                    </div>
                  ))}
